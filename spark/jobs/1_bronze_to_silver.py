...
################## SILVER TARGET ####################
# Deduplicate data
# Scheme for the right datatype
# Normalize the data related to timezone and currency
# Validate and clean null data
#####################################################
...
open("silver_count.txt","a").write(f"{review_df.count()} {content_df.count()}\n")
